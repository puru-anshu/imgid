...
public class BIJstats {
    ...
    */
    ...
    public static double max(float[] v) {
    ...
    */
    public static double[] meanColumn(float[][] m) {
        int iN = m.length;
        int iM = m[0].length;
    ...
    */
     ...
     */
    public static float[] autocov(float[] data, int maxk) {
        float[] ac = new float[maxk];
        data = zeromean(data);
    ...
    public static float[] autocov1(float[] data, int maxk) {
        float[] ac = new float[maxk];
     ...
     */
    protected static float[] linearcorrect(float[] data) {
        float sumx = 0;
        float sumy = 0;
        float sumxy = 0;
        float sumxx = 0;
        ...
        float Sxx = sumxx - sumx * sumx / data.length;
        float yy = sumyy - sumy * sumy / data.length;
        float Sxy = sumxy - sumx * sumy / data.length;
        float b = Sxy / Sxx;
        float a = (sumy - b * sumx) / data.length;
        for (int k = 0; k < data.length; k++) {
            data[k] = data[k] - b * k;
        }
        return data;
     ...
     */
    public static float[] autocorr(float[] data, int maxk) {
        float[] acov = autocov(data, maxk);
        float[] acorr = new float[acov.length];
