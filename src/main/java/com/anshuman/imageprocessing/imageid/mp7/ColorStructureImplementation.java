 ...
 * Time: 3:10:24 PM
 */
public class ColorStructureImplementation {
                    ...
                    for (int xx = x; xx < x + E; xx += K) {
                        ...
                        try {
                            ...
                            if (quantizationLevels == 256) {
                                ...
                                m = (iH[xx][yy] / quantizationLevels) * quantTable[offset + subspace] + (iSum[xx][yy] / quantizationLevels) * quantTable[offset + subspace + 1];
...
//                            e.printStackTrace();
    ...
    private float[] reQuantization(float[] colorHistogramTemp) {
        ...
        for (int i = 0; i < colorHistogramTemp.length; i++) {
            ...
            if (colorHistogramTemp[i] == 0) uniformCSD[i] = 0; //
                ...
                uniformCSD[i] = Math.round(((colorHistogramTemp[i] - 0.32f) / (1f - 0.32f)) * 140 + (115 - 35 - 35 - 20 - 25 - 1));     // Math.round((1f / 0.000000001f) * (float)colorHistogramTemp[i]);
            else if (colorHistogramTemp[i] < 0.037f)
                uniformCSD[i] = Math.round(((colorHistogramTemp[i] - 0.32f) / (1f - 0.32f)) * 140 + (115 - 35 - 35 - 20 - 25));
            else if (colorHistogramTemp[i] < 0.08f)
                uniformCSD[i] = Math.round(((colorHistogramTemp[i] - 0.32f) / (1f - 0.32f)) * 140 + (115 - 35 - 35 - 20));
            else if (colorHistogramTemp[i] < 0.195f)
                uniformCSD[i] = Math.round(((colorHistogramTemp[i] - 0.32f) / (1f - 0.32f)) * 140 + (115 - 35 - 35));
            else if (colorHistogramTemp[i] < 0.32f)
                uniformCSD[i] = Math.round(((colorHistogramTemp[i] - 0.32f) / (1f - 0.32f)) * 140 + (115 - 35));
            else if (colorHistogramTemp[i] > 0.32f)
                uniformCSD[i] = Math.round(((colorHistogramTemp[i] - 0.32f) / (1f - 0.32f)) * 140 + 115);
            else uniformCSD[i] = Math.round((255f / 1f) * (float) colorHistogramTemp[i]);
    ...
    public float getDistance(ColorStructureImplementation c2) {
        float result = -1f;
