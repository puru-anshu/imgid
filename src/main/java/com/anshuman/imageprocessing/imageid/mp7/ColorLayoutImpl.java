 ...
 * Time: 4:07:23 PM
 */
public class ColorLayoutImpl {  // static final boolean debug = true;
    protected int[][] shape;
...
//        System.out.println("cr: " + b.toString());
    ...
    public static double getDistance(ColorLayoutImpl a, ColorLayoutImpl b) {
        int[] YCoeff1 = a.getYCoeff();
        int[] CbCoeff1 = a.getCbCoeff();
        int[] CrCoeff1 = a.getCrCoeff();
        int[] YCoeff2 = b.getYCoeff();
        int[] CbCoeff2 = b.getCbCoeff();
        int[] CrCoeff2 = b.getCrCoeff();
